/**
 * Rasterize assets/og-image.html into public/og-image.png.
 *
 * Run by hand when the card changes, not as part of the build. The PNG is
 ...
 *
 * Needs playwright-core and a Chromium. Point CHROMIUM_PATH at the binary if
 * it is not where Playwright usually puts it.
 */
...
// Open Graph consumers expect exactly this, and a card that is not 1200x630
